...
def product_details(request):
    return render(request, 'base/prod/product_details.html')


def address(request):
    return render(request, 'base/checkout/address.html')


def payment(request):
    return render(request, 'base/checkout/payment.html')


def success_msg(request):
    return render(request, 'base/checkout/success_msg.html')


def rent(request):
    return render(request, 'base/rent/rent.html')


def contact(request):
    return render(request, 'base/contact/contact.html')


def aboutus(request):
    return render(request, 'base/about/aboutus.html')
